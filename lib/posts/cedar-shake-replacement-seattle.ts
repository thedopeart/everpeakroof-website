...
const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      type: "stat-row",
      stats: [
        { value: "30 to 40 yrs", label: "Age of most Seattle cedar shake roofs right now, all hitting end of life in the same window" },
    ...
    {
      type: "paragraph",
      text: "You don't need to climb the roof to spot it. From the ground, look for shakes that are **curling at the edges**, splitting lengthwise, or missing entirely. Moss is a huge factor. Cedar is porous, and when moss holds moisture against the wood for months at a time (which it does in Seattle from October through May), the shake goes soft. We call it 'punky.' You can push your thumb through it.",
    },
    {
      type: "paragraph",
      text: "Other signs: **dark staining** that runs down the roof in streaks, shakes that have shifted out of alignment, and **daylight visible in the attic** where shakes have cracked all the way through. A [roof inspection](/services/roof-inspection) confirms it, but most homeowners already know by the time they call us.",
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      rows: [
        { cells: [{ text: "Installed cost" }, { text: "$14 to $20 / sq ft", badge: "red" }, { text: "$7 to $9 / sq ft", badge: "green" }] },
        { cells: [{ text: "PNW lifespan" }, { text: "20 to 25 yrs (if maintained)" }, { text: "25 to 30 yrs" }] },
    ...
    {
      type: "paragraph",
      text: "**Synthetic shake** is the option for homeowners who want the cedar look without the cedar problems. Products like DaVinci and Brava mimic the texture of real cedar but are made from engineered polymers, Class A fire ratings, **$12 to $16 per square foot**.",
    },
    {
      type: "paragraph",
      text: "**Metal roofing** is the third option, still rare on residential cedar tear-offs, but growing. Standing seam metal lasts 50+ years and handles PNW weather like nothing else. If you want a deeper comparison on materials, our [best roofing materials for the PNW](/blog/best-roofing-materials-pnw) guide breaks it all down.",
    },
    {
      type: "heading",
    ...
    },
    {
      type: "callout",
      variant: "info",
      title: "Skip sheathing adds $2,000 to $4,000 to the job",
