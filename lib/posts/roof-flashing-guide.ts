  ...
  blocks: [
    ...
    },
    {
      ...
      stats: [
        ...
        { value: "8–12 yrs", label: "How long sealant at flashing joints lasts before cracking under PNW moisture cycling" },
        { value: "$150–$1,500", label: "Repair cost range depending on type — pipe boot at the low end, full chimney reflash at the high end" },
      ],
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      rows: [
        { cells: [{ text: "Step flashing" }, { text: "Roof slope meets a vertical wall" }, { text: "Water stain on interior wall near junction" }, { text: "$400–$900" }] },
        { cells: [{ text: "Counter flashing" }, { text: "Tucked into chimney mortar or wall reglet" }, { text: "Gap between metal and masonry" }, { text: "$600–$1,500" }] },
        { cells: [{ text: "Valley flashing" }, { text: "Where two roof slopes meet" }, { text: "Rust, debris dams, staining along valley" }, { text: "$500–$1,200" }] },
        { cells: [{ text: "Drip edge" }, { text: "Along eaves and rakes" }, { text: "Rust, bent sections, fascia rot below" }, { text: "$200–$500" }] },
        { cells: [{ text: "Kick-out flashing" }, { text: "Bottom of roof-to-wall transition" }, { text: "Bubbling siding paint, wall rot" }, { text: "$150–$400" }] },
        { cells: [{ text: "Pipe boot flashings" }, { text: "Around plumbing vent pipes" }, { text: "Cracked rubber, gap between collar and pipe" }, { text: "$150–$300" }] },
      ],
    },
    {
      type: "heading",
