...
const post: BlogPost = {
  ...
  title: "How to File a Roof Insurance Claim in Washington State",
  excerpt:
  ...
  blocks: [
    ...
    },
    {
      ...
      stats: [
        ...
        { value: "3 to 4 wks", label: "Typical adjuster wait time after a major Seattle windstorm, when every carrier gets slammed at once" },
    ...
    {
      type: "heading",
      text: "Step 3 to 5: Call, get your own inspection, meet the adjuster",
    },
    {
      type: "callout",
      variant: "tip",
    ...
    {
      type: "paragraph",
      text: "If your 15-year-old roof costs **$18,000 to replace** and has $5,000 in depreciation under an RCV policy, you get a check for **$13,000 upfront**. The remaining $5,000 comes after you finish the job and submit paperwork.",
    },
    {
      type: "paragraph",
      text: "Read every line and make sure the adjuster included all damaged components: underlayment, flashing, drip edge, ridge caps, and any rotted decking. If something gets left off the scope, you'll be paying for it out of pocket later.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "This happens more than it should. The adjuster's scope misses the **ice and water shield**, skips the chimney flashing, or uses material pricing from 2019. If the payout doesn't cover the actual cost of the work, your roofer can file a supplement, a detailed Xactimate estimate showing line by line what was missed and what it actually costs.",
    },
    {
      type: "paragraph",
      text: "We've recovered **thousands in supplemental payouts** for homeowners who would have eaten the difference. Our [insurance restoration](/services/insurance-restoration) service handles this regularly, and a [roof inspection](/services/roof-inspection) is usually where it starts.",
    },
    {
      type: "heading",
