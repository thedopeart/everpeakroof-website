...
const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      type: "stat-row",
      stats: [
        { value: "10:12 to 12:12", label: "Typical pitch on Upper Queen Anne Tudor Revivals, at 45 degrees, every crew member needs a harness" },
        ...
        { value: "+30 to 50%", label: "Typical labor premium on steep Queen Anne roofs vs. a standard ranch, physics, not padding" },
      ],
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Plan on **30 to 50 percent more labor** compared to a standard 6:12 ranch roof just because of access and safety equipment. Any contractor who quotes you the same rate per square for a 12:12 pitch as a 5:12 is either cutting corners on safety or hasn't been up there yet.",
    },
    {
      type: "heading",
      text: "Wind, real wind",
    ...
    {
      type: "paragraph",
      text: "Homes that are 100-plus years old have chimneys that have moved. Brick settles, mortar joints crack, and the chimney slowly pulls away from the roof deck. The flashing installed during the last re-roof might have been fine at the time, but if the chimney has shifted even a quarter inch since then, water is getting in. This is the **most common source of mystery leaks** on Upper Queen Anne.",
    },
    {
      type: "paragraph",
      text: "Homeowner sees a water stain near the fireplace, assumes the worst, and it turns out the **step flashing just needs to be re-done**. That's a [roof repair](/services/roof-repair), not a catastrophe. Cedar shake is still out there on a lot of these homes too, 1980s and 1990s re-roofs that are now **30 to 40 years old**, well past their useful life in Seattle's climate. Our [cedar shake replacement guide](/blog/cedar-shake-replacement-seattle) covers what to expect.",
    },
    {
      type: "heading",
