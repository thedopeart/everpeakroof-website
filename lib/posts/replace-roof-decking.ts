  ...
  blocks: [
    ...
    },
    {
      ...
      stats: [
        ...
        { value: "$75–$150", label: "Cost per sheet of plywood to replace during a reroof — includes demo, material, and installation" },
    ...
    },
    {
      ...
      rows: [
        { cells: [{ text: "Normal — a few bad sheets" }, { text: "10–15 sheets replaced during reroof" }, { text: "$2,000–$4,000" }] },
        { cells: [{ text: "Worse — widespread damage" }, { text: "30–40% of the deck" }, { text: "$5,000–$8,000" }] },
        { cells: [{ text: "Full re-deck" }, { text: "Entire deck replaced" }, { text: "$8,000–$12,000+" }] },
        { cells: [{ text: "Cedar shake conversion" }, { text: "Skip sheathing → solid plywood" }, { text: "$3,000–$6,000" }] },
      ],
    },
    {
      type: "heading",
