...
const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      type: "stat-row",
      stats: [
        { value: "2000–05", label: "When most Bellevue second-generation roofs were installed — putting them right at end of life now" },
        { value: "$500–$2,200", label: "Typical repair range for common Bellevue issues — chimney flashing, skylight reflash, ridge cap damage" },
    ...
    },
    {
      ...
      rows: [
        { cells: [{ text: "Shingle replacement, small section" }, { text: "$400–$900" }, { text: "A few courses, no decking involved" }] },
        { cells: [{ text: "Ridge cap repair after wind" }, { text: "$600–$1,800" }, { text: "Somerset especially common after storms" }] },
        { cells: [{ text: "Skylight reflash, full reset" }, { text: "$1,000–$2,000" }, { text: "Assumes skylight unit is still good" }] },
        { cells: [{ text: "Chimney flashing rebuild" }, { text: "$800–$2,200" }, { text: "Both step and counter flashing replaced" }] },
        { cells: [{ text: "Cedar shake spot repair" }, { text: "$500–$1,500" }, { text: "Buys time — doesn't change the end of life" }] },
        { cells: [{ text: "Full cedar tear-off, reroof" }, { text: "$25,000–$50,000+" }, { text: "Includes re-deck with solid plywood" }] },
      ],
    },
    {
      type: "callout",
