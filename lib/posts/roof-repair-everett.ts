...
const post: BlogPost = {
  ...
  blocks: [
    {
      type: "paragraph",
      text: "We make the drive up I-5 to [Everett](/everett) more often than people assume. Snohomish County is home turf, and some of our most consistent [roof repair](/services/roof-repair) work comes out of Everett neighborhoods. If you're out there wondering whether a Seattle-based roofer actually shows up when you call, yes, and we'd rather be in your driveway than stuck on a phone tree.",
    },
    {
      type: "stat-row",
      stats: [
        { value: "1960s, 80s", label: "When most Everett housing stock was built, old enough that second-generation roofs are now failing" },
        { value: "$400 to $700", label: "Typical Everett repair for a pipe boot and flashing, similar to south Sound pricing" },
        { value: "5 to 10 yrs", label: "Life lost on underventilated Everett attics from that era, they cook the decking from the inside" },
      ],
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      rows: [
        { cells: [{ text: "Pipe boot and flashing repair" }, { text: "$400 to $700" }, { text: "Most common call after any wind event" }] },
        { cells: [{ text: "Section of shingles plus decking repair" }, { text: "$1,500 to $4,000" }, { text: "Varies by scope and access" }] },
        { cells: [{ text: "Full tear-off, 2,000 sq ft rambler" }, { text: "$12,000 to $22,000" }, { text: "Depends on pitch, material, and access" }] },
        { cells: [{ text: "Ridge cap and wind damage repair" }, { text: "$500 to $1,500" }, { text: "Common in Bayside after storm season" }] },
      ],
    },
    {
      type: "callout",
    ...
    {
      type: "paragraph",
      text: "And if you want the basics on what our [general roof repair services](/services/roof-repair) include, that page lays out the whole process. For storm-season damage that can't wait, our [emergency roof repair](/services/emergency-roof-repair) crew handles the urgent calls. We'd rather overshare than undersell.",
    },
  ],
};
