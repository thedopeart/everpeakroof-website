...
const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      type: "stat-row",
      stats: [
        { value: "$7 to $9", label: "Per sq ft installed for architectural shingles, typical 2,000 sq ft roof: $14k, $22k" },
        { value: "$12 to $18", label: "Per sq ft installed for standing seam metal, same roof: $24k, $36k" },
    ...
    },
    {
      ...
      rows: [
        ...
        { cells: [{ text: "Lifespan (PNW)" }, { text: "25 to 30 years" }, { text: "40 to 50 years" }] },
        { cells: [{ text: "Moss shedding" }, { text: "Moderate, textured surface grabs spores" }, { text: "Better, slicker surface sheds easier" }] },
        { cells: [{ text: "Wind rating (with correct nailing)" }, { text: "110 to 130 mph" }, { text: "140+ mph" }] },
