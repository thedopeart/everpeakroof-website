...
const post: BlogPost = {
  ...
  blocks: [
    ...
    {
      type: "paragraph",
      text: "Valleys take more water than any other part of the roof because both slopes funnel into them. Fir needles packed into a valley dam up and push water sideways under the shingles. Clean them out. While you're at it, look at the flashing around the chimney and skylights. Cracked caulk or a separation at the counter-flashing is one of the most common leak sources on older Seattle homes. It's a cheap fix in October, an expensive one in January.",
    },
    {
      type: "callout",
      variant: "warning",
