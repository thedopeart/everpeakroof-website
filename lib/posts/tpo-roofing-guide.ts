...
const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      type: "stat-row",
      stats: [
        { value: "$8–$12", label: "Per sq ft installed for TPO in Seattle (2026) — between EPDM and PVC, with welded seams like PVC" },
        { value: "20–30 yrs", label: "Expected TPO lifespan with proper maintenance — install quality is the biggest variable" },
    ...
    },
    {
      ...
      rows: [
        { cells: [{ text: "TPO" }, { text: "$8–$12 / sq ft" }, { text: "Heat-welded", badge: "green" }, { text: "Excellent", badge: "green" }, { text: "Most Seattle commercial buildings" }] },
        { cells: [{ text: "EPDM (rubber)" }, { text: "$6–$9 / sq ft", badge: "green" }, { text: "Taped and glued", badge: "amber" }, { text: "Poor — glued seams fail in wet climates", badge: "red" }, { text: "Dry climates; not recommended here" }] },
        { cells: [{ text: "PVC" }, { text: "$10–$16 / sq ft", badge: "amber" }, { text: "Heat-welded", badge: "green" }, { text: "Excellent", badge: "green" }, { text: "Restaurants, buildings with grease exhaust" }] },
      ],
    },
    {
      type: "heading",
