...
const post: BlogPost = {
  ...
  blocks: [
    ...
    {
      type: "paragraph",
      text: "You file a claim and get a claim number. The adjuster comes out (usually **1 to 2 weeks**, longer after major storms) and writes a scope of work using software called **Xactimate**. That scope determines your payout. Here's the thing: the initial offer is a starting point, not a final answer.",
    },
    {
      type: "paragraph",
      text: "Adjusters write lean scopes, they'll include shingles but leave out the ice and water shield, or they'll price labor below what any legitimate contractor in Seattle charges. That's not necessarily bad faith. It's just how the system works. Your roofer needs to know how to **read an Xactimate estimate and challenge it line by line**.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "**RCV (Replacement Cost Value):** Pays to replace the damaged roof at today's prices. Usually holds back the depreciation amount until work is completed. You get the first check up front, do the job, then submit for the 'recoverable depreciation' to get the rest.",
    },
    {
      type: "paragraph",
      text: "**ACV (Actual Cash Value):** Deducts depreciation based on roof age. If your roof is 18 years old, the carrier might only pay **40% of the replacement cost**. Check your policy. This detail alone can swing the payout by **thousands of dollars**.",
    },
    {
      type: "callout",
      variant: "tip",
