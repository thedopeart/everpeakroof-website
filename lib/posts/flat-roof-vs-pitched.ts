...
const post: BlogPost = {
  ...
  title: "Flat Roof vs Pitched Roof: Pros, Cons, and Seattle Costs",
  excerpt:
  ...
  blocks: [
    ...
    },
    {
      ...
      stats: [
        ...
        { value: "25 to 30 yrs", label: "Lifespan of a well-installed architectural shingle pitched roof in the PNW" },
        { value: "20 to 25 yrs", label: "Realistic lifespan of a quality TPO flat roof membrane with good maintenance in Seattle" },
      ],
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      rows: [
        { cells: [{ text: "Installed cost" }, { text: "$6 to $12 / sq ft" }, { text: "$7 to $9 / sq ft" }] },
        { cells: [{ text: "PNW lifespan" }, { text: "20 to 25 yrs with maintenance" }, { text: "25 to 30 yrs" }] },
    ...
    {
      type: "paragraph",
      text: "A flat roof isn't truly flat. It has a slight slope (usually a quarter inch per foot) so water moves toward the drains. In practice, with **150 or more rain days a year** in Seattle, drainage is the single biggest concern. The main materials for flat roofs are **TPO, EPDM (rubber membrane), and modified bitumen**.",
    },
    {
      type: "paragraph",
      text: "TPO is the most popular choice for [commercial roofing](/services/commercial-roofing) right now because it's durable, reflects heat, and welds at the seams for a watertight bond. **EPDM is cheaper** but the seams are glued, which can fail over time in our wet climate.",
    },
    {
      type: "callout",
      variant: "warning",
    ...
    {
      type: "paragraph",
      text: "Walk through any neighborhood in Wallingford, Ravenna, or West Seattle and you'll see pitched roofs everywhere. A pitched roof **sheds water naturally**, gravity does the heavy lifting. Rain rolls off, debris slides down, and the surface dries faster between storms. That natural drainage advantage is a big deal in a city where it rains eight months of the year.",
    },
    {
      type: "paragraph",
      text: "Material options are wider too. Architectural asphalt shingles are the go-to for most [roof replacements](/services/roof-replacement) in the area, running **$6.50 to $9.50 per square foot** installed. Pitched roofs also give you attic space, which matters for ventilation.",
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Flat roofs work well for **commercial buildings, ADUs, and modern designs** where the owner is willing to stay on top of maintenance. **Pitched roofs are the safer bet** for most residential homes in the Seattle area because they handle our rain with less effort and fewer surprises.",
    },
    {
      type: "paragraph",
      text: "If you're weighing the two for a specific project, [get a quote from us](/contact) and we'll walk you through the tradeoffs for your building. Our [roof inspection checklist](/blog/roof-inspection-checklist) covers what to look for on both types.",
    },
  ],
};
