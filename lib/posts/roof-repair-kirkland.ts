...
const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      type: "stat-row",
      stats: [
        { value: "$250–$500", label: "Cost per pipe boot replacement — one of the most common calls we get from Rose Hill and Totem Lake" },
        { value: "~15 yrs", label: "How long moss takes to do serious damage to a shaded Finn Hill roof without any treatment" },
        { value: "$500–$3,500", label: "Repair cost range for the four most common Kirkland issues — varies by scope and access" },
      ],
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      rows: [
        { cells: [{ text: "Missing or lifted shingles (handful)" }, { text: "$350–$800" }, { text: "Quick, assuming no deck damage" }] },
        { cells: [{ text: "Ridge cap repair, 10–20 ft" }, { text: "$500–$1,200" }, { text: "Common after Lake Washington wind events" }] },
        { cells: [{ text: "New pipe boot" }, { text: "$250–$500 per boot" }, { text: "Fast fix — delays become expensive" }] },
        { cells: [{ text: "Step flashing replacement at wall" }, { text: "$600–$1,500" }, { text: "More involved — shingles must be woven back in" }] },
        { cells: [{ text: "Skylight reflash" }, { text: "$800–$1,800" }, { text: "Usually the flashing, not the glass" }] },
        { cells: [{ text: "Section of rotted decking + reshingle" }, { text: "$1,500–$3,500" }, { text: "Often found after chasing a persistent leak" }] },
      ],
    },
    {
      type: "callout",
