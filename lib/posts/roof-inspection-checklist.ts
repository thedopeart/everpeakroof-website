...
const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      type: "stat-row",
      stats: [
        { value: "45 to 60 min", label: "How long a real roof inspection takes, not the 15-minute pass a home inspector does during escrow" },
        { value: "2 to 3 yrs", label: "Recommended inspection frequency for roofs over 15 years old, the sweet spot for catching problems cheap" },
