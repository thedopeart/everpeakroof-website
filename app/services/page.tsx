...
export const metadata: Metadata = {
  ...
  description:
    "Full roofing services in Seattle and the Puget Sound — repair, replacement, metal, flat, emergency, inspections, gutters, siding, and insurance claims.",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((svc) => (
            <Link
              ...
              className="group flex flex-col bg-white rounded-2xl border border-[#E5DDD3] p-7 hover:shadow-[0_8px_28px_rgba(45,90,71,0.12)] hover:-translate-y-1 transition-all duration-200"
            >
              ...
              <p className="text-sm text-[#6B7280] leading-relaxed flex-1">{svc.shortDesc}</p>
